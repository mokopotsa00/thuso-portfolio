<template>
  <section class="pw-widget"
        ...
        <article v-for="(p, i) in PROJECTS"
          ...
          <div class="pw-card-detail">
            ...
            <div class="pw-detail-actions">
              ...
              <span v-else
                class="pw-btn pw-btn-disabled">Proprietary</span>
              <button class="pw-btn"
                type="button"
                @click.stop="expandedIdx = -1">
                <svg viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2.2"
    ...
    <div class="pw-footer"
      :class="{ show: showFooter }">
      <button class="pw-view-more"
        type="button"
        @click="$emit('enterCenter')">
...
.pw-header {
  ...
  background: linear-gradient(180deg, rgba(255, 255, 255, .025), transparent), radial-gradient(ellipse at top left, rgba(63, 185, 80, .08), transparent 60%);
  flex-shrink: 0;
}
...
.pw-card::before {
  ...
  box-shadow: 0 0 10px var(--accent, var(--c-green));
  opacity: .7;
...
.pw-card.expanded {
  cursor: default;
  transform: none;
  border-color: var(--accent, var(--c-green));
  background: linear-gradient(135deg, rgba(63, 185, 80, .06), rgba(255, 255, 255, .02));
}

.pw-card.expanded .pw-card-desc {
...
.pw-card.expanded .pw-card-detail {
  max-height: 520px;
  opacity: 1;
  margin-top: 10px;
}
...
.pw-preview {
  ...
  height: 120px;
  border-radius: 8px;
  background: linear-gradient(135deg, rgba(188, 140, 255, .18), rgba(88, 199, 255, .12));
...
.pw-btn-demo:hover {
  ...
  box-shadow: 0 6px 18px rgba(188, 140, 255, .3);
}
...
.pw-view-more {
  ...
  padding: 9px 14px;
  border-radius: 10px;
  background: linear-gradient(135deg, rgba(63, 185, 80, .12), rgba(188, 140, 255, .12));
  border: 1px dashed rgba(63, 185, 80, .45);
  color: var(--chalk);
  font-family: 'Caveat', cursive;
  font-weight: 700;
  font-size: 1.12rem;
...
.pw-view-more:hover {
  transform: translateY(-2px);
  background: linear-gradient(135deg, rgba(63, 185, 80, .22), rgba(188, 140, 255, .22));
  box-shadow: 0 8px 20px rgba(63, 185, 80, .25);
}
